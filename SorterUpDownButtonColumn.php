...
/**
 * SorterUpDownButtonColumn class file.
 *
...
/**
 * SorterUpDownButtonColumn
 * 
 * @author Krivtsov Artur (wartur) <gwartur@gmail.com> | Made in Russia
 * @since v1.0.0
 */
class SorterUpDownButtonColumn extends CButtonColumn {
	...
	public function init() {
		if (empty($this->header)) {
			$this->header = Yii::t('SorterUpDownButtonColumn', 'Order');
		}
...
EOD;
		...
		if (empty($this->buttons)) {
			$this->buttons = array(
				'begin' => array(
					'label' => 'B',
					'url' => 'Yii::app()->controller->createUrl("sorterMoveToBegin", array("id" => $data->id))',
					'click' => $js,
					'options' => array(
						'class' => 'moveToBegin'
					)
				...
				'upNumber' => array(
					...
					'url' => 'Yii::app()->controller->createUrl("sorterMoveUpNumber", array("id" => $data->id, SorterAbstractMoveNumber::NUMBER_PARAM => $this->numberUp))',
					'click' => $js,
					'options' => array(
						'class' => 'moveUpNumber'
					)
				...
				'up' => array(
					'label' => 'U',
					'url' => 'Yii::app()->controller->createUrl("sorterMoveUp", array("id" => $data->id))',
					'click' => $js,
					'options' => array(
						'class' => 'moveUp'
					)
				...
				'down' => array(
					'label' => 'D',
					'url' => 'Yii::app()->controller->createUrl("sorterMoveDown", array("id" => $data->id))',
					'click' => $js,
					'options' => array(
						'class' => 'moveDown'
					)
				...
				'downNumber' => array(
					...
					'url' => 'Yii::app()->controller->createUrl("sorterMoveDownNumber", array("id" => $data->id, SorterAbstractMoveNumber::NUMBER_PARAM => $this->numberDown))',
					'click' => $js,
					'options' => array(
				...
				'end' => array(
					'label' => 'E',
					'url' => 'Yii::app()->controller->createUrl("sorterMoveToEnd", array("id" => $data->id))',
					'click' => $js,
					'options' => array(
						'class' => 'moveToEnd'
					)
