...
Расширение для Yii для работы с упорядоченным списком управляемым пользователем. При использовании данного расширения не забывайте пользоваться транзакциями или блокировками таблиц

ДЕМО: http://yii-sorter.wartur.ru

[Описание алгоритма](https://github.com/wartur/yii-sorter/blob/master/ALGORITHM.ru.md)

## Релиз 1.0.0 для Yii первый и последний. Дальнейшая разработка [будет проводиться на Yii2](https://github.com/wartur/yii2-sorter)
...
использованному алгоритму, данное расширение удобно использовать для работы с
