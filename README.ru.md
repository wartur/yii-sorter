...
за исполнение beforeSave, afterSave, все ваши события на использованных
...
который требуется только при разработки проекта). За целостность данных можно не волноваться
