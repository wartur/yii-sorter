...
> низменного, пошлого и никому ну нужного в практике перфекционизма,
...
> и стабильный механизм для решения достаточно простой и достаточно частой задачи
...
---------------------
Для удобного просмотра внутренней информации вы можете воспользоваться данной колонкой,
ничего интересного в этом нет, но все же если надо =)
```php
'columns' => array(
	array(
		'type' => 'raw',
