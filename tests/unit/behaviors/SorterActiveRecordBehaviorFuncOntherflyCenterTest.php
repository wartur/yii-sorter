 ...
 */
class SorterActiveRecordBehaviorFuncOntherflyCenterTest extends CDbTestCase {

	/**
	 * @var string model name
	 */
	private static $className = 'SortestOntheflyCenterStd';
	...
	public function testOntheflyNormalisation() {
		...
		$this->assertEquals(1073938432, $this->loadModel(70)->owner->sort); // but not double search
		$this->assertEquals(1073119232, $this->loadModel(45)->owner->sort); // but not double search
	}
}
