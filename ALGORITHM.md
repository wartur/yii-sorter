...
Минус алгоритма работающего на разряженных массивах в том,
...
Кроме того можно наблюдать в конце списка очень плохую разряжённость массива, а вначале слишком разряженную.
...
Для этого зададим параметр, назовем его Мощность Разряжённости(МР) по умолчанию.
...
Минимальная Локальная Мощность Разряжённости (МЛМР). Этот параметр гарантирует
...
Далее на этом диапазоне ищется Локальная Мощность Разряжённости (ЛМР).
...
разряжённости которое получается после нормализации на границах диапазона.
