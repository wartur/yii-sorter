...
Разряженный массив
------------------
Допустим, что у нас есть разряженный массив с записями индексированный по возрастанию.
...
Кроме того можно наблюдать в конце списка очень плохую разряженность массива, а вначалае слишком разряженную.
...
разряженности которое получается после нормализации на границах диапазона.
...
16 - 496
```
Есть еще 2 специальных ситуации при распределении,
